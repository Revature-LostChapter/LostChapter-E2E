...
public class Steps {
	...
	@When("I type in a signup username of {string}")
	...
	@When("I type in an signup email of {string}")
	...
	public void i_select_a_signup_role_of(String string) {
		...
		this.signupPage.signup.clickRoleSelect();
		this.signupPage.signup.clickUserRole();
